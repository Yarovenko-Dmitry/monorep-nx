export const serverResponse: serverRawResponseType = {
  ...
  "results": [
    ...
    },
    {
      ...
      "overview": "Kat and Borja appear to be a perfect couple, but as in every marriage they keep secrets, lies and infidelities that will come to light the night an unexpected visitor arrives.",
      "popularity": 2528.826,
